...
<section class="hnji">
    <main >
        ...
        <center>
        <form name=bookingFrm method=post action='MyBookings.php'>
        <h3> <u>BOOKING DETAILS</u></h3>
    <ol type = 1>
    <li>Models</li>
    <select name="sno" id="models">
        <option value="1">Mercedes-Benz E-Clas</option>
        <option value="2">Mercedes-Benz A-Clas</option>
        <option value="3">Mercedes-Benz C-Clas</option>
        <option value="4">Mercedes-Benz S-Clas</option>
        <option value="5">Mercedes-Benz GLS</option>
   ...
   <li>Showrooms</li>
    <select name="sid" id="country">
        <option value="1">Silver Arrows, Delhi</option>
        <option value="2">Noida Mercedes, Noida</option>
        <option value="3">Chaudhary Mercedes, Gurugram</option>
        <option value="4">Shivaji Mercedes, Mumbai</option>
        <option value="5">Anna Mercedes, Chennai</option>
    </select>
    <li>User ID:</li>
